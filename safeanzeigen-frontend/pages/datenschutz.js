    ...
    <div>
      ...
      <div className="flex justify-center min-h-screen font-semibold text-justify select-none py-8text-lg bg-gray-50">
        <div className="w-2/5 mx-20 text-left">
          ...
          E-Mail-Adresse:{" "}
          <p>
            <a href="mailto:hallo@safeanzeigen.de">hallo@safeanzeigen.de</a>
          </p>
          Impressum:{" "}
          <p>
            <a
          ...
          <ul className="m-elements">
            ...
            <li>
              <strong>Profile der Nutzer sind öffentlich: </strong>Die Profile
              der Nutzer sind öffentlich sichtbar und zugänglich.
            </li>
            <li>
          ...
          <ul className="m-elements">
            <li>
              ...
              den Browser der Nutzer sowie zu Zwecken der Sicherheit, als auch
