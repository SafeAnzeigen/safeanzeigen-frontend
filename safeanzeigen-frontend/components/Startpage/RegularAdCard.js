  ...
  return (
    <div className="transition duration-300 ease-out transform cursor-pointer select-none hover:scale-105">
      <div className="relative w-64 h-64">
        ...
        <div className="absolute right-0 z-30 float-left py-1 pl-4 pr-2 text-lg font-bold text-white rounded-tl-md rounded-bl-md bottom-10 bg-gradient-to-l bg-[#2f70e9e8] to-transparent">
          {priceType}{" "}
